...
export default {
    setup() {
        ...
        // Aggiungi un watcher per aggiornare i bottoni quando lo stato di autenticazione cambia
        watch(isAuthenticated, (newValue) => {
            if (newValue) {
                closePopUp(); // Chiudi il popup quando l'utente è autenticato
            } else {
                closePopUp(); // Chiudi il popup quando l'utente è disconnesso
            }
        });
