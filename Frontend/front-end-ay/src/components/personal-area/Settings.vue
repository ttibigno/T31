...
<div class="mx-auto right-0 mt-2 w-60">
    <div class="bg-white rounded overflow-hidden shadow-lg">
        ...
        <p class="pt-2 text-lg font-semibold text-gray-50"></p>
        <p class="text-sm text-gray-100">{{this.userData.name}}</p>
        <div class="mt-5">
            <a
...
<script>
    export default {
        ...
        methods:{
            async fetchUserData() {
                try {
                    const response = await fetch('https://localhost:8000/api/v1/users/private', {
                        method: 'GET',
                        headers: {
