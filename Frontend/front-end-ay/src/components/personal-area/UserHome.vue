            ...
            <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
              <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                ...
                <div class="p-4 text-right">
                  <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Activities created</p>
              ...
              <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                ...
                <div class="p-4 text-right">
                  <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Total Participants</p>
              ...
              <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                ...
                <div class="p-4 text-right">
                  <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Total saved</p>
              ...
              <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                ...
                <div class="p-4 text-right">
                  <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Polls</p>
            ...
            <div class="mb-4 grid grid-cols-1 gap-6 xl:grid-cols-3">
                <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md overflow-hidden xl:col-span-2">
                  <div class="relative bg-clip-border rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none m-0 flex items-center justify-between p-6">
                    <div>
                      <h6 class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-blue-gray-900 mb-1">Activities</h6>
                    </div>
                  </div>
                    ...
                    <table class="w-full min-w-[640px] table-auto">
                      ...
                      <tbody>
                        <tr v-for="activity in activities" :key="activity.id">
                          ...
                          <td class="py-3 px-5 border-b border-blue-gray-50 text-center">
                            <button @click="deleteActivity(activity.id)" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Delete</button>
                          </td>
                          <td class="py-3 px-5 border-b border-blue-gray-50 text-center">
                ...
                <div v-if="editingActivity" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                  <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
                    <h2 class="text-lg font-semibold mb-4 text-center text-gray-800">Editing Mode</h2>
    ...
    export default{
        ...
        methods: {
            async deleteActivity(activity){
                try{
                    await fetch(`http://localhost:8000/activivities/${this.activity._id}`, 
                    {
                        method: 'DELETE',
                        headers: {
            ...
            async completeActitivy(activity){
              try{
                await fetch(`http://localhost:8000/api/v1/activities/${this.editingActivity.id}`, {
                  method: 'PUT',
                  headers: {
                    'Authorization': 'Bearer'+ localStorage.getItem('authToken'),
                    'Content-Type': 'application/json',
            ...
            async saveUpdateActivity(){
                try {
                  await fetch(`http://localhost:8000/api/v1/activities/${this.editingActivity._id}`, {
                    method: 'PUT',
                    headers: {
                      'Authorization': 'Bearer '+ localStorage.getItem('authToken'),
                      'Content-Type': 'application/json',
                  ...
                  this.activities = this.activities.map(a => a.id === this.editingActivity.id? this.editingActivity : a);
                  this.closeEditModal();
                }catch(error){
                  alert(error.message);
                  console.error(error);
        ...
        async created(){
            try{
            const res = await fetch('http://localhost:8000/api/v1/activities/my', {
                method: 'GET',
                headers: {
                    'Authorization': 'Bearer ' + localStorage.getItem('authToken'),
                    'Content-Type': 'application/json',
